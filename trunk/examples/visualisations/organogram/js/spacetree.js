...
function loadPost(deptSlug,postSlug) {
	...
	var api_url = "http://danpaulsmith.com/puelia2/doc/department/"+deptSlug+"/post/"+postSlug;
	...
	$.ajax({
		...
		success: function(json){
				...
				api_url = "http://danpaulsmith.com/puelia2/doc/department/"+deptSlug+"/post/"+postSlug+"/reports";
				api_call_info.push({
